...
struct DialogViewModel: DialogViewModelType {
  ...
  static func nameModel() -> DialogViewModel {
    return DialogViewModel(title: CHAssets.localized("ch.name_verification.title"),
                           message: CHAssets.localized("ch.name_verification.description"),
                           footer: CHAssets.localized("ch.agreement"),
                           ...
                           errorFooter: CHAssets.localized("ch.agreement"),
                           type: .UserName)
  }
  
  static func phoneModel() -> DialogViewModel {
    return DialogViewModel(title: CHAssets.localized("ch.mobile_verification.title"),
  ...
  static func completeModel() -> DialogViewModel {
    return DialogViewModel(title: CHAssets.localized("ch.complete_verification.title"),
                           message: "",
                           footer:  "",
                           errorTitle: "",
                           errorMessage: "",
  ...
  static func defaultModel() -> DialogViewModel {
    return DialogViewModel(title: "title",
                           message: "",
                           footer:  "",
                           errorTitle: "",
                           errorMessage: "",
  ...
  //add any similar data model type here ...
