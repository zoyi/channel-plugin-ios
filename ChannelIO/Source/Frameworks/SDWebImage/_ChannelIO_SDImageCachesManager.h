...
typedef NS_ENUM(NSUInteger, _ChannelIO_SDImageCachesManagerOperationPolicy) {
 ...
 */
@interface _ChannelIO_SDImageCachesManager : NSObject <_ChannelIO_SDImageCache>
 ...
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageCachesManager *sharedManager;
 ...
 */
@property (nonatomic, assign) _ChannelIO_SDImageCachesManagerOperationPolicy queryOperationPolicy;

/**
 Operation policy for store op.
 Defaults to `HighestOnly`, means store to the highest priority cache only.
 */
@property (nonatomic, assign) _ChannelIO_SDImageCachesManagerOperationPolicy storeOperationPolicy;

/**
 Operation policy for remove op.
 Defaults to `Concurrent`, means remove all caches concurrently.
 */
@property (nonatomic, assign) _ChannelIO_SDImageCachesManagerOperationPolicy removeOperationPolicy;
 ...
 */
@property (nonatomic, assign) _ChannelIO_SDImageCachesManagerOperationPolicy containsOperationPolicy;

/**
 Operation policy for clear op.
 Defaults to `Concurrent`, means clear all caches concurrently.
 */
@property (nonatomic, assign) _ChannelIO_SDImageCachesManagerOperationPolicy clearOperationPolicy;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<_ChannelIO_SDImageCache>> *caches;
...
/**
 ...
 @param cache cache
 */
- (void)addCache:(nonnull id<_ChannelIO_SDImageCache>)cache;
...
/**
 ...
 @param cache cache
 */
- (void)removeCache:(nonnull id<_ChannelIO_SDImageCache>)cache;
