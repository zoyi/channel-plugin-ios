...
#if SD_UIKIT
typedef UIViewAnimationOptions _ChannelIO_SDWebImageAnimationOptions;
#else
typedef NS_OPTIONS(NSUInteger, _ChannelIO_SDWebImageAnimationOptions) {
...
typedef void (^_ChannelIO_SDWebImageTransitionPreparesBlock)(__kindof UIView * _Nonnull view, UIImage * _Nullable image, NSData * _Nullable imageData, _ChannelIO_SDImageCacheType cacheType, NSURL * _Nullable imageURL);
typedef void (^_ChannelIO_SDWebImageTransitionAnimationsBlock)(__kindof UIView * _Nonnull view, UIImage * _Nullable image);
typedef void (^_ChannelIO_SDWebImageTransitionCompletionBlock)(BOOL finished);
 ...
 */
@interface _ChannelIO_SDWebImageTransition : NSObject
 ...
 */
@property (nonatomic, assign) _ChannelIO_SDWebImageAnimationOptions animationOptions;
/**
 A block object to be executed before the animation sequence starts.
 */
@property (nonatomic, copy, nullable) _ChannelIO_SDWebImageTransitionPreparesBlock prepares;
/**
 A block object that contains the changes you want to make to the specified view.
 */
@property (nonatomic, copy, nullable) _ChannelIO_SDWebImageTransitionAnimationsBlock animations;
/**
 A block object to be executed when the animation sequence ends.
 */
@property (nonatomic, copy, nullable) _ChannelIO_SDWebImageTransitionCompletionBlock completion;
 ...
 */
@interface _ChannelIO_SDWebImageTransition (Conveniences)

/// Fade-in transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *fadeTransition;
/// Flip from left transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *flipFromLeftTransition;
/// Flip from right transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *flipFromRightTransition;
/// Flip from top transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *flipFromTopTransition;
/// Flip from bottom transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *flipFromBottomTransition;
/// Curl up transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *curlUpTransition;
/// Curl down transition.
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageTransition *curlDownTransition;
