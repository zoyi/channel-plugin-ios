...
@class _ChannelIO_SDWebImagePrefetcher;

/**
 A token represents a list of URLs, can be used to cancel the download.
 */
@interface _ChannelIO_SDWebImagePrefetchToken : NSObject <_ChannelIO_SDWebImageOperation>
 ...
 */
@protocol _ChannelIO_SDWebImagePrefetcherDelegate <NSObject>
 ...
 */
- (void)imagePrefetcher:(nonnull _ChannelIO_SDWebImagePrefetcher *)imagePrefetcher didPrefetchURL:(nullable NSURL *)imageURL finishedCount:(NSUInteger)finishedCount totalCount:(NSUInteger)totalCount;
 ...
 */
- (void)imagePrefetcher:(nonnull _ChannelIO_SDWebImagePrefetcher *)imagePrefetcher didFinishWithTotalCount:(NSUInteger)totalCount skippedCount:(NSUInteger)skippedCount;

@end

typedef void(^_ChannelIO_SDWebImagePrefetcherProgressBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfTotalUrls);
typedef void(^_ChannelIO_SDWebImagePrefetcherCompletionBlock)(NSUInteger noOfFinishedUrls, NSUInteger noOfSkippedUrls);

/**
 * Prefetch some URLs in the cache for future use. Images are downloaded in low priority.
 */
@interface _ChannelIO_SDWebImagePrefetcher : NSObject
 ...
 */
@property (strong, nonatomic, readonly, nonnull) _ChannelIO_SDWebImageManager *manager;
 ...
 */
@property (weak, nonatomic, nullable) id <_ChannelIO_SDWebImagePrefetcherDelegate> delegate;

/**
 * Returns the global shared image prefetcher instance. It use a standalone manager which is different from shared manager.
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDWebImagePrefetcher *sharedImagePrefetcher;

/**
 * Allows you to instantiate a prefetcher with any arbitrary image manager.
 */
- (nonnull instancetype)initWithImageManager:(nonnull _ChannelIO_SDWebImageManager *)manager NS_DESIGNATED_INITIALIZER;
