 ...
 */
@interface _ChannelIO_SDImageCodersManager : NSObject <_ChannelIO_SDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<_ChannelIO_SDImageCoder>> *coders;
