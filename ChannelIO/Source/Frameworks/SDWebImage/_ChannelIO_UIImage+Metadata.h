 ...
 */
@interface UIImage (_ChannelIO_Metadata)
 ...
 */
@property (nonatomic, assign) NSUInteger _ChannelIO_sd_imageLoopCount;
 ...
 */
@property (nonatomic, assign, readonly) BOOL _ChannelIO_sd_isAnimated;
 ...
 */
@property (nonatomic, assign, readonly) BOOL _ChannelIO_sd_isVector;
 ...
 */
@property (nonatomic, assign) _ChannelIO_SDImageFormat _ChannelIO_sd_imageFormat;

/**
 A bool value indicating whether the image is during incremental decoding and may not contains full pixels.
 */
@property (nonatomic, assign) BOOL _ChannelIO_sd_isIncremental;
