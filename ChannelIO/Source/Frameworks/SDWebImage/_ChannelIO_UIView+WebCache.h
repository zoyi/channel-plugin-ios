 ...
 */
FOUNDATION_EXPORT const int64_t _ChannelIO_SDWebImageProgressUnitCountUnknown; /* 1LL */

typedef void(^_ChannelIO_SDSetImageBlock)(UIImage * _Nullable image, NSData * _Nullable imageData, _ChannelIO_SDImageCacheType cacheType, NSURL * _Nullable imageURL);

/**
 Integrates SDWebImage async downloading and caching of remote images with UIView subclass.
 */
@interface UIView (_ChannelIO_WebCache)
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *_ChannelIO_sd_imageURL;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *_ChannelIO_sd_latestOperationKey;
 ...
 */
@property (nonatomic, strong, null_resettable) NSProgress *_ChannelIO_sd_imageProgress;
 ...
 */
@property (nonatomic, strong, nullable) _ChannelIO_SDWebImageTransition *_ChannelIO_sd_imageTransition;
 ...
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageIndicator> _ChannelIO_sd_imageIndicator;
