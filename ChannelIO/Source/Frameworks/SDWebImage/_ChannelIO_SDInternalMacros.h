...
#import "_ChannelIO_SDmetamacros.h"
...
#define onExit \
sd_keywordify \
__strong _ChannelIO_sd_cleanupBlock_t metamacro_concat(sd_exitBlock_, __LINE__) __attribute__((cleanup(_ChannelIO_sd_executeCleanupBlock), unused)) = ^
#endif

typedef void (^_ChannelIO_sd_cleanupBlock_t)(void);
