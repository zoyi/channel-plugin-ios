...
FOUNDATION_EXPORT NSErrorDomain const _Nonnull _ChannelIO_SDWebImageErrorDomain;

/// The HTTP status code for invalid download response (NSNumber *)
FOUNDATION_EXPORT NSErrorUserInfoKey const _Nonnull _ChannelIO_SDWebImageErrorDownloadStatusCodeKey;

/// SDWebImage error domain and codes
typedef NS_ERROR_ENUM(_ChannelIO_SDWebImageErrorDomain, _ChannelIO_SDWebImageError) {
