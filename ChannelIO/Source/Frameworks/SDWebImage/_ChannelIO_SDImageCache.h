...
/// Image Cache Options
typedef NS_OPTIONS(NSUInteger, _ChannelIO_SDImageCacheOptions) {
    /**
 ...
 */
@interface _ChannelIO_SDImageCache : NSObject
 ...
 */
@property (nonatomic, copy, nonnull, readonly) _ChannelIO_SDImageCacheConfig *config;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<_ChannelIO_SDMemoryCache> memoryCache;
 ...
 */
@property (nonatomic, strong, readonly, nonnull) id<_ChannelIO_SDDiskCache> diskCache;
 ...
 */
@property (nonatomic, copy, nullable) _ChannelIO_SDImageCacheAdditionalCachePathBlock additionalCachePathBlock;
 ...
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageCache *sharedImageCache;
...
- (nonnull instancetype)initWithNamespace:(nonnull NSString *)ns
                       diskCacheDirectory:(nullable NSString *)directory
                                   config:(nullable _ChannelIO_SDImageCacheConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 *  @note the completion block will be always executed on the main queue
 */
- (void)diskImageDataQueryForKey:(nullable NSString *)key completion:(nullable _ChannelIO_SDImageCacheQueryDataCompletionBlock)completionBlock;
 ...
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key done:(nullable _ChannelIO_SDImageCacheQueryCompletionBlock)doneBlock;
 ...
 * @return a NSOperation instance containing the cache op
 */
- (nullable NSOperation *)queryCacheOperationForKey:(nullable NSString *)key options:(_ChannelIO_SDImageCacheOptions)options done:(nullable _ChannelIO_SDImageCacheQueryCompletionBlock)doneBlock;
 ...
 */
@interface _ChannelIO_SDImageCache (_ChannelIO_SDImageCache) <_ChannelIO_SDImageCache>
