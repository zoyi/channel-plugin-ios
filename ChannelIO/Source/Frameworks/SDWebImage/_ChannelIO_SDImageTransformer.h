 ...
 */
FOUNDATION_EXPORT NSString * _Nullable _ChannelIO_SDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
 ...
 */
FOUNDATION_EXPORT NSString * _Nullable _ChannelIO_SDThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);
 ...
 */
@protocol _ChannelIO_SDImageTransformer <NSObject>
 ...
 */
@interface _ChannelIO_SDImagePipelineTransformer : NSObject <_ChannelIO_SDImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<_ChannelIO_SDImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<_ChannelIO_SDImageTransformer>> *)transformers;
 ...
 */
@interface _ChannelIO_SDImageRoundCornerTransformer: NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageResizingTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) _ChannelIO_SDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(_ChannelIO_SDImageScaleMode)scaleMode;
 ...
 */
@interface _ChannelIO_SDImageCroppingTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageFlippingTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageRotationTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageTintTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageBlurTransformer : NSObject <_ChannelIO_SDImageTransformer>
 ...
 */
@interface _ChannelIO_SDImageFilterTransformer: NSObject <_ChannelIO_SDImageTransformer>
