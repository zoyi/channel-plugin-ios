 ...
 */
@protocol _ChannelIO_SDWebImageIndicator <NSObject>
 ...
 */
@interface _ChannelIO_SDWebImageActivityIndicator : NSObject <_ChannelIO_SDWebImageIndicator>
 ...
 */
@interface _ChannelIO_SDWebImageActivityIndicator (Conveniences)

/// These indicator use the fixed color without dark mode support
/// gray-style activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *grayIndicator;
/// large gray-style activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *grayLargeIndicator;
/// white-style activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *whiteIndicator;
/// large white-style activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *whiteLargeIndicator;
/// These indicator use the system style, supports dark mode if available (iOS 13+/macOS 10.14+)
/// large activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *largeIndicator;
/// medium activity indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageActivityIndicator *mediumIndicator;
 ...
 */
@interface _ChannelIO_SDWebImageProgressIndicator : NSObject <_ChannelIO_SDWebImageIndicator>
 ...
 */
@interface _ChannelIO_SDWebImageProgressIndicator (Conveniences)

/// default-style progress indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageProgressIndicator *defaultIndicator;
/// bar-style progress indicator
@property (nonatomic, class, nonnull, readonly) _ChannelIO_SDWebImageProgressIndicator *barIndicator API_UNAVAILABLE(macos, tvos);
