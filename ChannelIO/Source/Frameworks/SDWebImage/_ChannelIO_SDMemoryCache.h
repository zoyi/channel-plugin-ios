...
@class _ChannelIO_SDImageCacheConfig;
/**
 A protocol to allow custom memory cache used in SDImageCache.
 */
@protocol _ChannelIO_SDMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull _ChannelIO_SDImageCacheConfig *)config;
 ...
 */
@interface _ChannelIO_SDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <_ChannelIO_SDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) _ChannelIO_SDImageCacheConfig *config;
