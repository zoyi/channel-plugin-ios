...
/// Downloader options
typedef NS_OPTIONS(NSUInteger, _ChannelIO_SDWebImageDownloaderOptions) {
    /**
...
FOUNDATION_EXPORT NSNotificationName _Nonnull const _ChannelIO_SDWebImageDownloadStartNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const _ChannelIO_SDWebImageDownloadReceiveResponseNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const _ChannelIO_SDWebImageDownloadStopNotification;
FOUNDATION_EXPORT NSNotificationName _Nonnull const _ChannelIO_SDWebImageDownloadFinishNotification;

typedef _ChannelIO_SDImageLoaderProgressBlock _ChannelIO_SDWebImageDownloaderProgressBlock;
typedef _ChannelIO_SDImageLoaderCompletedBlock _ChannelIO_SDWebImageDownloaderCompletedBlock;

/**
 *  A token associated with each download. Can be used to cancel a download
 */
@interface _ChannelIO_SDWebImageDownloadToken : NSObject <_ChannelIO_SDWebImageOperation>
 ...
 */
@interface _ChannelIO_SDWebImageDownloader : NSObject
 ...
 */
@property (nonatomic, copy, readonly, nonnull) _ChannelIO_SDWebImageDownloaderConfig *config;
 ...
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageDownloaderRequestModifier> requestModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageDownloaderResponseModifier> responseModifier;
 ...
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageDownloaderDecryptor> decryptor;
 ...
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDWebImageDownloader *sharedDownloader;
 ...
 */
- (nonnull instancetype)initWithConfig:(nullable _ChannelIO_SDWebImageDownloaderConfig *)config NS_DESIGNATED_INITIALIZER;
 ...
 */
@interface _ChannelIO_SDWebImageDownloader (SDImageLoader) <_ChannelIO_SDImageLoader>
