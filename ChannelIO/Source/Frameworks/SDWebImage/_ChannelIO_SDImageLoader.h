...
typedef void(^_ChannelIO_SDImageLoaderProgressBlock)(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL);
typedef void(^_ChannelIO_SDImageLoaderCompletedBlock)(UIImage * _Nullable image, NSData * _Nullable data, NSError * _Nullable error, BOOL finished);
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextLoaderCachedImage;
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable _ChannelIO_SDImageLoaderDecodeImageData(NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, _ChannelIO_SDWebImageOptions options, _ChannelIO_SDWebImageContext * _Nullable context);
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable _ChannelIO_SDImageLoaderDecodeProgressiveImageData(NSData * _Nonnull imageData, NSURL * _Nonnull imageURL, BOOL finished,  id<_ChannelIO_SDWebImageOperation> _Nonnull operation, _ChannelIO_SDWebImageOptions options, _ChannelIO_SDWebImageContext * _Nullable context);
...
*/
@protocol _ChannelIO_SDImageLoader <NSObject>
 ...
 */
- (nullable id<_ChannelIO_SDWebImageOperation>)requestImageWithURL:(nullable NSURL *)url
                                              ...
                                              completed:(nullable _ChannelIO_SDImageLoaderCompletedBlock)completedBlock;
