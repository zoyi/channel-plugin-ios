 ...
 */
@interface NSButton (_ChannelIO_WebCache)
 ...
 */
- (void)_ChannelIO_sd_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)_ChannelIO_sd_setAlternateImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
