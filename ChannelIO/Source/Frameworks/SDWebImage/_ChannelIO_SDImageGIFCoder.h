 ...
 */
@interface _ChannelIO_SDImageGIFCoder : _ChannelIO_SDImageIOAnimatedCoder <_ChannelIO_SDProgressiveImageCoder, _ChannelIO_SDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageGIFCoder *sharedCoder;
