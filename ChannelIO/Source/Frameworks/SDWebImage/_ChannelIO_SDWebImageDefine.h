...
typedef void(^_ChannelIO_SDWebImageNoParamsBlock)(void);
typedef NSString * _ChannelIO_SDWebImageContextOption NS_EXTENSIBLE_STRING_ENUM;
typedef NSDictionary<_ChannelIO_SDWebImageContextOption, id> _ChannelIO_SDWebImageContext;
typedef NSMutableDictionary<_ChannelIO_SDWebImageContextOption, id> _ChannelIO_SDWebImageMutableContext;
 ...
 */
FOUNDATION_EXPORT CGFloat _ChannelIO_SDImageScaleFactorForKey(NSString * _Nullable key);
 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable _ChannelIO_SDScaledImageForKey(NSString * _Nullable key, UIImage * _Nullable image);
...
/**
 ...
 @return The scaled image
 */
FOUNDATION_EXPORT UIImage * _Nullable _ChannelIO_SDScaledImageForScaleFactor(CGFloat scale, UIImage * _Nullable image);

#pragma mark - WebCache Options

/// WebCache options
typedef NS_OPTIONS(NSUInteger, _ChannelIO_SDWebImageOptions) {
    /**
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextSetImageOperationKey;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextCustomManager API_DEPRECATED("Use individual context option like .imageCache, .imageLoader and .imageTransformer instead", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageCache;
...
*/
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageLoader;
...
*/
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageCoder;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageTransformer;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageScaleFactor;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImagePreserveAspectRatio;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextImageThumbnailPixelSize;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextQueryCacheType;
...
/**
 ...
 If not provide or the value is invalid, we will use `SDImageCacheTypeAll`. (NSNumber)
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextStoreCacheType;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextOriginalQueryCacheType;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextOriginalStoreCacheType;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextAnimatedImageClass;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextDownloadRequestModifier;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextDownloadResponseModifier;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextDownloadDecryptor;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextCacheKeyFilter;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDWebImageContextOption _Nonnull const _ChannelIO_SDWebImageContextCacheSerializer;
