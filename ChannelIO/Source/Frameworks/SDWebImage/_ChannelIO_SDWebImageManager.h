...
typedef void(^_ChannelIO_SDExternalCompletionBlock)(UIImage * _Nullable image, NSError * _Nullable error, _ChannelIO_SDImageCacheType cacheType, NSURL * _Nullable imageURL);

typedef void(^_ChannelIO_SDInternalCompletionBlock)(UIImage * _Nullable image, NSData * _Nullable data, NSError * _Nullable error, _ChannelIO_SDImageCacheType cacheType, BOOL finished, NSURL * _Nullable imageURL);

/**
 A combined operation representing the cache and loader operation. You can use it to cancel the load process.
 */
@interface _ChannelIO_SDWebImageCombinedOperation : NSObject <_ChannelIO_SDWebImageOperation>
 ...
 */
@property (strong, nonatomic, nullable, readonly) id<_ChannelIO_SDWebImageOperation> cacheOperation;

/**
 The loader operation from the image loader (such as download operation)
 */
@property (strong, nonatomic, nullable, readonly) id<_ChannelIO_SDWebImageOperation> loaderOperation;

@end


@class _ChannelIO_SDWebImageManager;

/**
 The manager delegate protocol.
 */
@protocol _ChannelIO_SDWebImageManagerDelegate <NSObject>
 ...
 */
- (BOOL)imageManager:(nonnull _ChannelIO_SDWebImageManager *)imageManager shouldDownloadImageForURL:(nonnull NSURL *)imageURL;
 ...
 */
- (BOOL)imageManager:(nonnull _ChannelIO_SDWebImageManager *)imageManager shouldBlockFailedURL:(nonnull NSURL *)imageURL withError:(nonnull NSError *)error;
 ...
 * @endcode
 */
@interface _ChannelIO_SDWebImageManager : NSObject

/**
 * The delegate for manager. Defaults to nil.
 */
@property (weak, nonatomic, nullable) id <_ChannelIO_SDWebImageManagerDelegate> delegate;

/**
 * The image cache used by manager to query image cache.
 */
@property (strong, nonatomic, readonly, nonnull) id<_ChannelIO_SDImageCache> imageCache;

/**
 * The image loader used by manager to load image.
 */
@property (strong, nonatomic, readonly, nonnull) id<_ChannelIO_SDImageLoader> imageLoader;
 ...
 */
@property (strong, nonatomic, nullable) id<_ChannelIO_SDImageTransformer> transformer;
 ...
 * @endcode
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageCacheKeyFilter> cacheKeyFilter;
 ...
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageCacheSerializer> cacheSerializer;
...
/**
 ...
 @endcode
 */
@property (nonatomic, strong, nullable) id<_ChannelIO_SDWebImageOptionsProcessor> optionsProcessor;
 ...
 */
@property (nonatomic, class, nullable) id<_ChannelIO_SDImageCache> defaultImageCache;
 ...
 */
@property (nonatomic, class, nullable) id<_ChannelIO_SDImageLoader> defaultImageLoader;

/**
 * Returns global shared manager instance.
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDWebImageManager *sharedManager;
 ...
 */
- (nonnull instancetype)initWithCache:(nonnull id<_ChannelIO_SDImageCache>)cache loader:(nonnull id<_ChannelIO_SDImageLoader>)loader NS_DESIGNATED_INITIALIZER;
 ...
 */
- (nullable _ChannelIO_SDWebImageCombinedOperation *)loadImageWithURL:(nullable NSURL *)url
