 ...
 */
@interface NSImage (_ChannelIO_Compatibility)

/**
The underlying Core Graphics image object. This will actually use `CGImageForProposedRect` with the image size.
 */
@property (nonatomic, readonly, nullable) CGImageRef _ChannelIO_CGImage;
/**
 ...
 */
@property (nonatomic, readonly, nullable) CIImage *_ChannelIO_CIImage;
/**
 ...
 */
@property (nonatomic, readonly) CGFloat _ChannelIO_scale;
 ...
 */
- (nonnull instancetype)_ChannelIO_initWithCGImage:(nonnull CGImageRef)cgImage scale:(CGFloat)scale orientation:(CGImagePropertyOrientation)orientation;
...
/**
 ...
 @return The image object
 */
- (nonnull instancetype)_ChannelIO_initWithCIImage:(nonnull CIImage *)ciImage scale:(CGFloat)scale orientation:(CGImagePropertyOrientation)orientation;
...
/**
 ...
 @return The image object
 */
- (nullable instancetype)_ChannelIO_initWithData:(nonnull NSData *)data scale:(CGFloat)scale;
