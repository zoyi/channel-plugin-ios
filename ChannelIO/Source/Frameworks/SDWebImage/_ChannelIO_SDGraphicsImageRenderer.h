...
typedef void (^_ChannelIO_SDGraphicsImageDrawingActions)(CGContextRef _Nonnull context);
typedef NS_ENUM(NSInteger, _ChannelIO_SDGraphicsImageRendererFormatRange) {
...
@interface _ChannelIO_SDGraphicsImageRendererFormat : NSObject
...
@property (nonatomic) _ChannelIO_SDGraphicsImageRendererFormatRange preferredRange;
...
@interface _ChannelIO_SDGraphicsImageRenderer : NSObject
...
/// @return An initialized image renderer.
- (nonnull instancetype)initWithSize:(CGSize)size format:(nonnull _ChannelIO_SDGraphicsImageRendererFormat *)format;
...
- (nonnull UIImage *)imageWithActions:(nonnull NS_NOESCAPE _ChannelIO_SDGraphicsImageDrawingActions)actions;
