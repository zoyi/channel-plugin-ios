 ...
 */
@protocol _ChannelIO_SDAnimatedImage <_ChannelIO_SDAnimatedImageProvider>
 ...
 */
- (nullable instancetype)initWithData:(nonnull NSData *)data scale:(CGFloat)scale options:(nullable _ChannelIO_SDImageCoderOptions *)options;
...
/**
 ...
 @return An initialized object
 */
- (nullable instancetype)initWithAnimatedCoder:(nonnull id<_ChannelIO_SDAnimatedImageCoder>)animatedCoder scale:(CGFloat)scale;
...
/**
 ...
 @note We use this with animated coder which conforms to `SDProgressiveImageCoder` for progressive animation decoding.
 */
@property (nonatomic, strong, readonly, nullable) id<_ChannelIO_SDAnimatedImageCoder> animatedCoder;
 ...
 */
@interface _ChannelIO_SDAnimatedImage : UIImage <_ChannelIO_SDAnimatedImage>
 ...
 */
@property (nonatomic, assign, readonly) _ChannelIO_SDImageFormat animatedImageFormat;
