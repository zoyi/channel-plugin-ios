...
typedef NSURLRequest * _Nullable (^_ChannelIO_SDWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol _ChannelIO_SDWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface _ChannelIO_SDWebImageDownloaderRequestModifier : NSObject <_ChannelIO_SDWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull _ChannelIO_SDWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull _ChannelIO_SDWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface _ChannelIO_SDWebImageDownloaderRequestModifier (Conveniences)
