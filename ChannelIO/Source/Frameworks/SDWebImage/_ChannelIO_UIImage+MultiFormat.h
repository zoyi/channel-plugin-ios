 ...
 */
@interface UIImage (_ChannelIO_MultiFormat)
#pragma mark - Decode
/**
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)_ChannelIO_sd_imageDataAsFormat:(_ChannelIO_SDImageFormat)imageFormat NS_SWIFT_NAME(sd_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)_ChannelIO_sd_imageDataAsFormat:(_ChannelIO_SDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(sd_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)_ChannelIO_sd_imageDataAsFormat:(_ChannelIO_SDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(sd_imageData(as:compressionQuality:firstFrameOnly:));
