...
typedef NS_ENUM(NSUInteger, _ChannelIO_SDImageCacheConfigExpireType) {
    /**
 ...
 */
@interface _ChannelIO_SDImageCacheConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageCacheConfig *defaultCacheConfig;
 ...
 */
@property (assign, nonatomic) _ChannelIO_SDImageCacheConfigExpireType diskCacheExpireType;
