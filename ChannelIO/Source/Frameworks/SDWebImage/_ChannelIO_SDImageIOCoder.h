 ...
 */
@interface _ChannelIO_SDImageIOCoder : NSObject <_ChannelIO_SDProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageIOCoder *sharedCoder;
