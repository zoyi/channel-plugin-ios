...
@implementation NSBezierPath (_ChannelIO_SDRoundedCorners)

+ (instancetype)_ChannelIO_sd_bezierPathWithRoundedRect:(NSRect)rect byRoundingCorners:(SDRectCorner)corners cornerRadius:(CGFloat)cornerRadius {
