...
typedef NS_ENUM(NSUInteger, _ChannelIO_SDImageScaleMode) {
...
#else
typedef NS_OPTIONS(NSUInteger, _ChannelIO_SDRectCorner) {
 ...
 */
@interface UIImage (_ChannelIO_Transform)
 ...
 */
- (nullable UIImage *)_ChannelIO_sd_roundedCornerImageWithRadius:(CGFloat)cornerRadius
