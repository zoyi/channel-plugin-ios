...
typedef NS_ENUM(NSInteger, _ChannelIO_SDWebImageDownloaderExecutionOrder) {
    /**
 ...
 */
@interface _ChannelIO_SDWebImageDownloaderConfig : NSObject <NSCopying>
 ...
 */
@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDWebImageDownloaderConfig *defaultDownloaderConfig;
 ...
 */
@property (nonatomic, assign) _ChannelIO_SDWebImageDownloaderExecutionOrder executionOrder;
