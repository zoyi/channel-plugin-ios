...
static NSString * const _ChannelIO_SDDiskCacheExtendedAttributeName = @"com.hackemist.SDDiskCache";

@interface _ChannelIO_SDDiskCache ()
...
@implementation _ChannelIO_SDDiskCache
...
- (instancetype)initWithCachePath:(NSString *)cachePath config:(nonnull _ChannelIO_SDImageCacheConfig *)config {
    if (self = [super init]) {
...
- (NSData *)extendedDataForKey:(NSString *)key {
    ...
    NSData *extendedData = [_ChannelIO_SDFileAttributeHelper extendedAttribute:_ChannelIO_SDDiskCacheExtendedAttributeName atPath:cachePathForKey traverseLink:NO error:nil];
...
- (void)setExtendedData:(NSData *)extendedData forKey:(NSString *)key {
    ...
    if (!extendedData) {
        // Remove
        [_ChannelIO_SDFileAttributeHelper removeExtendedAttribute:_ChannelIO_SDDiskCacheExtendedAttributeName atPath:cachePathForKey traverseLink:NO error:nil];
    } else {
        // Override
        [_ChannelIO_SDFileAttributeHelper setExtendedAttribute:_ChannelIO_SDDiskCacheExtendedAttributeName value:extendedData atPath:cachePathForKey traverseLink:NO overwrite:YES error:nil];
    }
}
