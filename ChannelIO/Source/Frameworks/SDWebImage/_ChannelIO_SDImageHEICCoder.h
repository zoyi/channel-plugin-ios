...
@interface _ChannelIO_SDImageHEICCoder : _ChannelIO_SDImageIOAnimatedCoder <_ChannelIO_SDProgressiveImageCoder, _ChannelIO_SDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) _ChannelIO_SDImageHEICCoder *sharedCoder;
