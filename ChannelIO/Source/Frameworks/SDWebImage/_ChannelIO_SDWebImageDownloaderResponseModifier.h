...
typedef NSURLResponse * _Nullable (^_ChannelIO_SDWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol _ChannelIO_SDWebImageDownloaderResponseModifier <NSObject>
 ...
 */
@interface _ChannelIO_SDWebImageDownloaderResponseModifier : NSObject <_ChannelIO_SDWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull _ChannelIO_SDWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull _ChannelIO_SDWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface _ChannelIO_SDWebImageDownloaderResponseModifier (Conveniences)
