 ...
 */
@protocol _ChannelIO_SDDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull _ChannelIO_SDImageCacheConfig *)config;
 ...
 */
@interface _ChannelIO_SDDiskCache : NSObject <_ChannelIO_SDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) _ChannelIO_SDImageCacheConfig *config;
