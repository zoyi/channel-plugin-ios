 ...
 */
@interface _ChannelIO_SDImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<_ChannelIO_SDImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<_ChannelIO_SDImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
