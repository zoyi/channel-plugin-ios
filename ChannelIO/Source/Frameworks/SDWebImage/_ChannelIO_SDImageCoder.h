...
typedef NSString * _ChannelIO_SDImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<_ChannelIO_SDImageCoderOption, id> _ChannelIO_SDImageCoderOptions;
typedef NSMutableDictionary<_ChannelIO_SDImageCoderOption, id> _ChannelIO_SDImageCoderMutableOptions;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderDecodeFirstFrameOnly;
 ...
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`.
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeMaxPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT _ChannelIO_SDImageCoderOption _Nonnull const _ChannelIO_SDImageCoderEncodeEmbedThumbnail;
 ...
 */
@protocol _ChannelIO_SDImageCoder <NSObject>
...
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable _ChannelIO_SDImageCoderOptions *)options;
 ...
 */
- (BOOL)canEncodeToFormat:(_ChannelIO_SDImageFormat)format NS_SWIFT_NAME(canEncode(to:));
...
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(_ChannelIO_SDImageFormat)format
                                  options:(nullable _ChannelIO_SDImageCoderOptions *)options;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol _ChannelIO_SDProgressiveImageCoder <_ChannelIO_SDImageCoder>
 ...
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable _ChannelIO_SDImageCoderOptions *)options;
 ...
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable _ChannelIO_SDImageCoderOptions *)options;
 ...
 */
@protocol _ChannelIO_SDAnimatedImageProvider <NSObject>
 ...
 */
@protocol _ChannelIO_SDAnimatedImageCoder <_ChannelIO_SDImageCoder, _ChannelIO_SDAnimatedImageProvider>
