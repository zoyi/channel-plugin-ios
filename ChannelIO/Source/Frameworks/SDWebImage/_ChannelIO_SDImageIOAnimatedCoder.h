 ...
 */
@interface _ChannelIO_SDImageIOAnimatedCoder : NSObject <_ChannelIO_SDProgressiveImageCoder, _ChannelIO_SDAnimatedImageCoder>
 ...
 */
@property (class, readonly) _ChannelIO_SDImageFormat imageFormat;
/**
