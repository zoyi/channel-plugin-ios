 ...
 */
@protocol _ChannelIO_SDWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
 ...
 */
@interface _ChannelIO_SDWebImageDownloaderOperation : NSOperation <_ChannelIO_SDWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) _ChannelIO_SDWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) _ChannelIO_SDWebImageContext *context;
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(_ChannelIO_SDWebImageDownloaderOptions)options
                                context:(nullable _ChannelIO_SDWebImageContext *)context NS_DESIGNATED_INITIALIZER;
