 ...
 */
@interface UIButton (_ChannelIO_WebCache)
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *_ChannelIO_sd_currentImageURL;
...
- (void)_ChannelIO_sd_setImageWithURL:(nullable NSURL *)url
          ...
          placeholderImage:(nullable UIImage *)placeholder
                   options:(_ChannelIO_SDWebImageOptions)options NS_REFINED_FOR_SWIFT;
...
- (void)_ChannelIO_sd_setImageWithURL:(nullable NSURL *)url
                  forState:(UIControlState)state
          placeholderImage:(nullable UIImage *)placeholder
                 completed:(nullable _ChannelIO_SDExternalCompletionBlock)completedBlock NS_REFINED_FOR_SWIFT;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *_ChannelIO_sd_currentBackgroundImageURL;
