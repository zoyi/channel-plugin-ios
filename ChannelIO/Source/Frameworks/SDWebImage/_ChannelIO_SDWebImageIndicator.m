...
static NSInteger _ChannelIO_UIActivityIndicatorViewStyleMedium = 100;
static NSInteger _ChannelIO_UIActivityIndicatorViewStyleLarge = 101;
#endif
#endif

#pragma mark - Activity Indicator

@interface _ChannelIO_SDWebImageActivityIndicator ()
...
@implementation _ChannelIO_SDWebImageActivityIndicator
...
@implementation _ChannelIO_SDWebImageActivityIndicator (Conveniences)

#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
+ (_ChannelIO_SDWebImageActivityIndicator *)grayIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = [_ChannelIO_SDWebImageActivityIndicator new];
#if SD_UIKIT
#if SD_IOS
...
+ (_ChannelIO_SDWebImageActivityIndicator *)grayLargeIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = _ChannelIO_SDWebImageActivityIndicator.grayIndicator;
#if SD_UIKIT
...
+ (_ChannelIO_SDWebImageActivityIndicator *)whiteIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = [_ChannelIO_SDWebImageActivityIndicator new];
#if SD_UIKIT
...
+ (_ChannelIO_SDWebImageActivityIndicator *)whiteLargeIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = _ChannelIO_SDWebImageActivityIndicator.whiteIndicator;
#if SD_UIKIT
    indicator.indicatorView.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhiteLarge;
#else
    indicator.indicatorView.appearance = [NSAppearance appearanceNamed:NSAppearanceNameAqua]; // Disable dark mode support
...
+ (_ChannelIO_SDWebImageActivityIndicator *)largeIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = [_ChannelIO_SDWebImageActivityIndicator new];
#if SD_UIKIT
...
+ (_ChannelIO_SDWebImageActivityIndicator *)mediumIndicator {
    _ChannelIO_SDWebImageActivityIndicator *indicator = [_ChannelIO_SDWebImageActivityIndicator new];
#if SD_UIKIT
    if (@available(iOS 13.0, tvOS 13.0, *)) {
...
@interface _ChannelIO_SDWebImageProgressIndicator ()
...
@implementation _ChannelIO_SDWebImageProgressIndicator
...
@implementation _ChannelIO_SDWebImageProgressIndicator (Conveniences)

+ (_ChannelIO_SDWebImageProgressIndicator *)defaultIndicator {
    _ChannelIO_SDWebImageProgressIndicator *indicator = [_ChannelIO_SDWebImageProgressIndicator new];
    return indicator;
}

#if SD_IOS
+ (_ChannelIO_SDWebImageProgressIndicator *)barIndicator {
    _ChannelIO_SDWebImageProgressIndicator *indicator = [_ChannelIO_SDWebImageProgressIndicator new];
