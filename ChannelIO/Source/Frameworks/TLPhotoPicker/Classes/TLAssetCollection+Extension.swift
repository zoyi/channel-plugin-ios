...
enum TL_PHFetchedResultGroupedBy {
    case year
    case month
    case week
    case day
...
extension TLAssetsCollection {
    func enumarateFetchResult(groupedBy: TL_PHFetchedResultGroupedBy) -> Dictionary<String,[TLPHAsset]> {
    ...
    func section(groupedBy: TL_PHFetchedResultGroupedBy) -> [(String,[TLPHAsset])] {
