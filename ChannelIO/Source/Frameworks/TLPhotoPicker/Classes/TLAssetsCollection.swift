...
struct TLPHAsset {
    ...
    @discardableResult
    func cloudImageDownload(progressBlock: @escaping (Double) -> Void, completionBlock:@escaping (UIImage?)-> Void ) -> PHImageRequestID? {
        guard let phAsset = self.phAsset else { return nil }
    ...
    func tempCopyMediaFile(videoRequestOptions: PHVideoRequestOptions? = nil,
    ...
    func exportVideoFile(options: PHVideoRequestOptions? = nil,
                                outputURL: URL? = nil,
    ...
    static func asset(with localIdentifier: String) -> TLPHAsset? {
...
extension TLPHAsset: Equatable {
    static func ==(lhs: TLPHAsset, rhs: TLPHAsset) -> Bool {
...
struct TLAssetsCollection {
    ...
    var sections: [(title: String, assets: [TLPHAsset])]? = nil
    var count: Int {
        get {
    ...
    mutating func reloadSection(groupedBy: TL_PHFetchedResultGroupedBy) {
