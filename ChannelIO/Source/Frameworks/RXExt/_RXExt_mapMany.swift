...
extension _RXSwift_ObservableType where Element: Collection {
    /**
     ...
     */
    func mapMany<Result>(_ transform: @escaping (Element.Element) throws -> Result) -> _RXSwift_Observable<[Result]> {
