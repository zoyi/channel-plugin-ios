...
extension _RXSwift_ObservableType {
	...
	*/
	func subscribe<Object: AnyObject>(weak obj: Object, _ on: @escaping (Object) -> (_RXSwift_Event<Element>) -> Void) -> _RXSwift_Disposable {
	...
	*/
    func subscribe<Object: AnyObject>(
		...
		if let disposed = onDisposed {
			disposable = _RXSwift_Disposables.create(with: weakify(obj, method: disposed))
		} else {
			disposable = _RXSwift_Disposables.create()
		}

		let observer = _RXSwift_AnyObserver { [weak obj] (e: _RXSwift_Event<Element>) in
			guard let obj = obj else { return }
			switch e {
			case .next(let value):
				onNext?(obj)(value)
		...
		return _RXSwift_Disposables.create(self.asObservable().subscribe(observer), disposable)
	}
	...
	- returns: Subscription object used to unsubscribe from the observable sequence.
	*/
	func subscribeNext<Object: AnyObject>(weak obj: Object, _ onNext: @escaping (Object) -> (Element) -> Void) -> _RXSwift_Disposable {
	...
	- returns: Subscription object used to unsubscribe from the observable sequence.
	*/
	func subscribeError<Object: AnyObject>(weak obj: Object, _ onError: @escaping (Object) -> (Error) -> Void) -> _RXSwift_Disposable {
	...
	- returns: Subscription object used to unsubscribe from the observable sequence.
	*/
	func subscribeCompleted<Object: AnyObject>(weak obj: Object, _ onCompleted: @escaping (Object) -> () -> Void) -> _RXSwift_Disposable {
