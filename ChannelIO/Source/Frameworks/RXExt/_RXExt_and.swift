...
extension _RXSwift_ObservableType where Element == Bool {
	...
	*/
	func and() -> _RXSwift_Maybe<Element> {
		return _RXSwift_Maybe.create { observer in
			var gotValue = false
	...
	Use `asSingle()` or `asObservable()` to convert to your requirements.
	*/
    static func and<Collection: Swift.Collection>(_ collection: Collection)
        -> _RXSwift_Maybe<Element> where Collection.Element: _RXSwift_ObservableType, Collection.Element.Element == Element {
		return _RXSwift_Maybe.create { observer in
			...
			return _RXSwift_CompositeDisposable(disposables: subscriptions)
		}
	}
	...
	Use `asSingle()` or `asObservable()` to convert to your requirements.
	*/
	static func and<Observable: _RXSwift_ObservableType>(_ sources: Observable ...) -> _RXSwift_Maybe<Element> where Observable.Element == Element {
		return and(sources)
	}
}
