...
@interface _ChannelIO_JGProgressHUDPieIndicatorLayer : CALayer
...
@implementation _ChannelIO_JGProgressHUDPieIndicatorLayer
...
@implementation _ChannelIO_JGProgressHUDPieIndicatorView
...
- (void)setColor:(UIColor *)tintColor {
    ...
    [(_ChannelIO_JGProgressHUDPieIndicatorLayer *)self.layer setColor:self.color];
}
...
- (void)setFillColor:(UIColor *)fillColor {
    ...
    [(_ChannelIO_JGProgressHUDPieIndicatorLayer *)self.layer setFillColor:self.fillColor];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    [(_ChannelIO_JGProgressHUDPieIndicatorLayer *)self.layer setProgress:progress];
...
+ (Class)layerClass {
    return [_ChannelIO_JGProgressHUDPieIndicatorLayer class];
}
