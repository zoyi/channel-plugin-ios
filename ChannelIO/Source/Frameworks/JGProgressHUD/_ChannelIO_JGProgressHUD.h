...
@protocol _ChannelIO_JGProgressHUDDelegate;
 ...
 */
@interface _ChannelIO_JGProgressHUD : UIView

/**
 Designated initializer.
 @param style The appearance style of the HUD.
 */
- (instancetype __nonnull)initWithStyle:(_ChannelIO_JGProgressHUDStyle)style;

/**
 Convenience initializer.
 @param style The appearance style of the HUD.
 */
+ (instancetype __nonnull)progressHUDWithStyle:(_ChannelIO_JGProgressHUDStyle)style;

/**
 The appearance style of the HUD.
 @b Default: JGProgressHUDStyleExtraLight.
 */
@property (nonatomic, assign, readonly) _ChannelIO_JGProgressHUDStyle style;
 ...
 */
@property (nonatomic, weak, nullable) id <_ChannelIO_JGProgressHUDDelegate> delegate;
 ...
 */
@property (nonatomic, strong, nullable) _ChannelIO_JGProgressHUDIndicatorView *indicatorView;

/**
 The shadow cast by the @c HUDView. This value is optional. Setting this to @c nil means no shadow is cast by the HUD.
 @b Default: nil.
 */
@property (nonatomic, strong, nullable) _ChannelIO_JGProgressHUDShadow *shadow;
 ...
 */
@property (nonatomic, assign) _ChannelIO_JGProgressHUDPosition position;

/**
 The animation used for showing and dismissing the HUD.
 @b Default: JGProgressHUDFadeAnimation.
 */
@property (nonatomic, strong, nonnull) _ChannelIO_JGProgressHUDAnimation *animation;
 ...
 */
@property (nonatomic, assign) _ChannelIO_JGProgressHUDInteractionType interactionType;
#endif
 ...
 */
@property (nonatomic, assign) _ChannelIO_JGProgressHUDParallaxMode parallaxMode;
 ...
 */
@property (nonatomic, copy, nullable) void (^tapOnHUDViewBlock)(_ChannelIO_JGProgressHUD *__nonnull HUD);
 ...
 */
@property (nonatomic, copy, nullable) void (^tapOutsideBlock)(_ChannelIO_JGProgressHUD *__nonnull HUD);
#endif
...
@interface _ChannelIO_JGProgressHUD (HUDManagement)

/**
 @param view The view to return all visible progress HUDs for.
 @return All visible progress HUDs in the view.
 */
+ (NSArray<_ChannelIO_JGProgressHUD *> *__nonnull)allProgressHUDsInView:(UIView *__nonnull)view;

/**
 @param view The view to return all visible progress HUDs for.
 @return All visible progress HUDs in the view and its subviews.
 */
+ (NSArray<_ChannelIO_JGProgressHUD *> *__nonnull)allProgressHUDsInViewHierarchy:(UIView *__nonnull)view;

@end

@interface _ChannelIO_JGProgressHUD (Deprecated)
...
@protocol _ChannelIO_JGProgressHUDDelegate <NSObject>
 ...
 */
- (void)progressHUD:(_ChannelIO_JGProgressHUD *__nonnull)progressHUD willPresentInView:(UIView *__nonnull)view;

/**
 Called after the HUD appeared.
 @param view The view in which the HUD is presented.
 */
- (void)progressHUD:(_ChannelIO_JGProgressHUD *__nonnull)progressHUD didPresentInView:(UIView *__nonnull)view;

/**
 Called before the HUD will disappear.
 @param view The view in which the HUD is presented and will be dismissed from.
 */
- (void)progressHUD:(_ChannelIO_JGProgressHUD *__nonnull)progressHUD willDismissFromView:(UIView *__nonnull)view;

/**
 Called after the HUD has disappeared.
 @param view The view in which the HUD was presented and was be dismissed from.
 */
- (void)progressHUD:(_ChannelIO_JGProgressHUD *__nonnull)progressHUD didDismissFromView:(UIView *__nonnull)view;
