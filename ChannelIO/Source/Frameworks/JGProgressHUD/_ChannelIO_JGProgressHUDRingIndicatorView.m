...
@interface _ChannelIO_JGProgressHUDRingIndicatorLayer : CALayer
...
@implementation _ChannelIO_JGProgressHUDRingIndicatorLayer
...
@implementation _ChannelIO_JGProgressHUDRingIndicatorView
...
- (instancetype)initWithHUDStyle:(_ChannelIO_JGProgressHUDStyle)style {
    return [self init];
}
...
- (void)setRoundProgressLine:(BOOL)roundProgressLine {
    ...
    [(_ChannelIO_JGProgressHUDRingIndicatorLayer *)self.layer setRoundProgressLine:self.roundProgressLine];
}
...
- (void)setRingColor:(UIColor *)tintColor {
    ...
    [(_ChannelIO_JGProgressHUDRingIndicatorLayer *)self.layer setRingColor:self.ringColor];
}
...
- (void)setRingBackgroundColor:(UIColor *)backgroundTintColor {
    ...
    [(_ChannelIO_JGProgressHUDRingIndicatorLayer *)self.layer setRingBackgroundColor:self.ringBackgroundColor];
}
...
- (void)setRingWidth:(CGFloat)ringWidth {
    ...
    [(_ChannelIO_JGProgressHUDRingIndicatorLayer *)self.layer setRingWidth:self.ringWidth];
}
...
- (void)setProgress:(float)progress animated:(BOOL)animated {
    ...
    [(_ChannelIO_JGProgressHUDRingIndicatorLayer *)self.layer setProgress:self.progress];
...
- (void)setUpForHUDStyle:(_ChannelIO_JGProgressHUDStyle)style vibrancyEnabled:(BOOL)vibrancyEnabled {
...
+ (Class)layerClass {
    return [_ChannelIO_JGProgressHUDRingIndicatorLayer class];
}
