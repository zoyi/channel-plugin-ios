...
static CGRect _ChannelIO_JGProgressHUD_CGRectIntegral(CGRect rect) {
...
@interface _ChannelIO_JGProgressHUD () {
    BOOL _transitioning;
...
@property (nonatomic, strong, readonly, nonnull) _ChannelIO_JGProgressHUDIndicatorView *effectiveIndicatorView;

@end

@interface _ChannelIO_JGProgressHUDAnimation (Private)

@property (nonatomic, weak, nullable) _ChannelIO_JGProgressHUD *progressHUD;

@end

@implementation _ChannelIO_JGProgressHUD
 ...
 */
- (instancetype)initWithStyle:(_ChannelIO_JGProgressHUDStyle)style {
    ...
    if (self) {
        ...
        _indicatorView = [[_ChannelIO_JGProgressHUDIndeterminateIndicatorView alloc] init];
...
+ (instancetype)progressHUDWithStyle:(_ChannelIO_JGProgressHUDStyle)style {
    return [(_ChannelIO_JGProgressHUD *)[self alloc] initWithStyle:style];
}
...
- (void)setHUDViewFrameCenterWithSize:(CGSize)size insetViewFrame:(CGRect)viewFrame {
    ...
    CGRect updatedHUDFrame = _ChannelIO_JGProgressHUD_CGRectIntegral(frame);
...
- (void)layoutHUD {
    ...
    [UIView performWithoutAnimation:^{
        ...
        self->_textLabel.frame = _ChannelIO_JGProgressHUD_CGRectIntegral(labelFrame);
        self->_detailTextLabel.frame = _ChannelIO_JGProgressHUD_CGRectIntegral(detailFrame);
    }];
...
- (_ChannelIO_JGProgressHUDAnimation *)animation {
    if (!_animation) {
        self.animation = [_ChannelIO_JGProgressHUDFadeAnimation animation];
    }
...
- (void)setShadow:(_ChannelIO_JGProgressHUDShadow *)shadow {
...
- (void)setAnimation:(_ChannelIO_JGProgressHUDAnimation *)animation {
...
- (void)setParallaxMode:(_ChannelIO_JGProgressHUDParallaxMode)parallaxMode {
...
- (void)setPosition:(_ChannelIO_JGProgressHUDPosition)position {
...
- (void)setIndicatorView:(_ChannelIO_JGProgressHUDIndicatorView *)indicatorView {
...
- (void)setEffectiveIndicatorView:(_ChannelIO_JGProgressHUDIndicatorView * _Nonnull)effectiveIndicatorView {
...
@implementation _ChannelIO_JGProgressHUD (HUDManagement)

+ (NSArray *)allProgressHUDsInView:(UIView *)view {
    NSMutableArray *HUDs = [NSMutableArray array];
    
    for (UIView *v in view.subviews) {
        if ([v isKindOfClass:[_ChannelIO_JGProgressHUD class]]) {
            [HUDs addObject:v];
        }
    }
...
@implementation _ChannelIO_JGProgressHUD (Deprecated)
