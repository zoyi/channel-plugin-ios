 ...
 */
typedef NS_ENUM(NSUInteger, _ChannelIO_JGProgressHUDPosition) {
    /** Center position. */
 ...
 */
typedef NS_ENUM(NSUInteger, _ChannelIO_JGProgressHUDStyle) {
...
/**
 Interaction types.
 */
typedef NS_ENUM(NSUInteger, _ChannelIO_JGProgressHUDInteractionType) {
...
/**
 Parallax Modes.
 */
typedef NS_ENUM(NSUInteger, _ChannelIO_JGProgressHUDParallaxMode) {
