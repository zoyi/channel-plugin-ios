...
@interface _ChannelIO_JGProgressHUDIndicatorView () {
...
static void runOnNextRunLoop(void (^block)(void)) {
    [[NSRunLoop currentRunLoop] performSelector:@selector(runBlock:) target:[_ChannelIO_JGProgressHUDIndicatorView class] argument:(id)block order:0 modes:@[NSRunLoopCommonModes]];
}

@implementation _ChannelIO_JGProgressHUDIndicatorView
