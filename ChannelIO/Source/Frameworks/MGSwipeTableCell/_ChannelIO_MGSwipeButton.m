...
@implementation _ChannelIO_MGSwipeButton
...
+(instancetype) buttonWithTitle:(NSString *) title backgroundColor:(UIColor *) color callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
    return [self buttonWithTitle:title icon:nil backgroundColor:color callback:callback];
}

+(instancetype) buttonWithTitle:(NSString *) title backgroundColor:(UIColor *) color padding:(NSInteger) padding callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
...
+(instancetype) buttonWithTitle:(NSString *) title backgroundColor:(UIColor *) color insets:(UIEdgeInsets) insets callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
...
+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
    return [self buttonWithTitle:title icon:icon backgroundColor:color padding:10 callback:callback];
}

+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color padding:(NSInteger) padding callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
...
+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color insets:(UIEdgeInsets) insets callback:(_ChannelIO_MGSwipeButtonCallback) callback
{
    _ChannelIO_MGSwipeButton * button = [self buttonWithType:UIButtonTypeCustom];
...
-(BOOL) callMGSwipeConvenienceCallback: (_ChannelIO_MGSwipeTableCell *) sender
{
    if (_callback) {
