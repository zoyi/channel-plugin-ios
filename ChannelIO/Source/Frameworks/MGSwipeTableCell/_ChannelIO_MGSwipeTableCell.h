...
/** Transition types */
typedef NS_ENUM(NSInteger, _ChannelIO_MGSwipeTransition) {
...
/** Swipe directions */
typedef NS_ENUM(NSInteger, _ChannelIO_MGSwipeDirection) {
    MGSwipeDirectionLeftToRight = 0,
    MGSwipeDirectionRightToLeft
};

/** Swipe state */
typedef NS_ENUM(NSInteger, _ChannelIO_MGSwipeState) {
    MGSwipeStateNone = 0,
...
typedef NS_ENUM(NSInteger, _ChannelIO_MGSwipeExpansionLayout) {
...
typedef NS_ENUM(NSInteger, _ChannelIO_MGSwipeEasingFunction) {
 ...
 **/
@interface _ChannelIO_MGSwipeAnimation : NSObject
/** Animation duration in seconds. Default value 0.3 */
@property (nonatomic, assign) CGFloat duration;
/** Animation easing function. Default value EaseOutBounce */
@property (nonatomic, assign) _ChannelIO_MGSwipeEasingFunction easingFunction;
 ...
 * Swipe settings
 **/
@interface _ChannelIO_MGSwipeSettings: NSObject
/** Transition used while swiping buttons */
@property (nonatomic, assign) _ChannelIO_MGSwipeTransition transition;
...
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeAnimation * showAnimation;
/** Animation settings when the swipe buttons are hided */
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeAnimation * hideAnimation;
/** Animation settings when the cell is stretched from the swipe buttons */
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeAnimation * stretchAnimation;
 ...
 **/
@interface _ChannelIO_MGSwipeExpansionSettings: NSObject
...
@property (nonatomic, assign) _ChannelIO_MGSwipeExpansionLayout expansionLayout;
/** Animation settings when the expansion is triggered **/
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeAnimation * triggerAnimation;
...
@class _ChannelIO_MGSwipeTableCell;
 ...
 */
@protocol _ChannelIO_MGSwipeTableCellDelegate <NSObject>
 ...
 **/
-(BOOL) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell*) cell canSwipe:(_ChannelIO_MGSwipeDirection) direction fromPoint:(CGPoint) point;
-(BOOL) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell*) cell canSwipe:(_ChannelIO_MGSwipeDirection) direction DEPRECATED_ATTRIBUTE; //backwards compatibility
 ...
 **/
-(void) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell*) cell didChangeSwipeState:(_ChannelIO_MGSwipeState) state gestureIsActive:(BOOL) gestureIsActive;

/**
 * Called when the user clicks a swipe button or when a expandable button is automatically triggered
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell*) cell tappedButtonAtIndex:(NSInteger) index direction:(_ChannelIO_MGSwipeDirection)direction fromExpansion:(BOOL) fromExpansion;
/**
 ...
 **/
-(nullable NSArray<UIView*>*) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell*) cell swipeButtonsForDirection:(_ChannelIO_MGSwipeDirection)direction
             swipeSettings:(nonnull _ChannelIO_MGSwipeSettings*) swipeSettings expansionSettings:(nonnull _ChannelIO_MGSwipeExpansionSettings*) expansionSettings;

/**
 * Called when the user taps on a swiped cell
 * @return YES to autohide the current swipe buttons
 **/
-(BOOL) swipeTableCell:(nonnull _ChannelIO_MGSwipeTableCell *)cell shouldHideSwipeOnTap:(CGPoint) point;

/**
 * Called when the cell will begin swiping
 * Useful to make cell changes that only are shown after the cell is swiped open
 **/
-(void) swipeTableCellWillBeginSwiping:(nonnull _ChannelIO_MGSwipeTableCell *) cell;

/**
 * Called when the cell will end swiping
 **/
-(void) swipeTableCellWillEndSwiping:(nonnull _ChannelIO_MGSwipeTableCell *) cell;
 ...
 */
@interface _ChannelIO_MGSwipeTableCell : UITableViewCell

/** optional delegate (not retained) */
@property (nonatomic, weak, nullable) id<_ChannelIO_MGSwipeTableCellDelegate> delegate;
...
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeSettings * leftSwipeSettings;
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeSettings * rightSwipeSettings;

/** Optional settings to allow expandable buttons */
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeExpansionSettings * leftExpansion;
@property (nonatomic, strong, nonnull) _ChannelIO_MGSwipeExpansionSettings * rightExpansion;

/** Readonly property to fetch the current swipe state */
@property (nonatomic, readonly) _ChannelIO_MGSwipeState swipeState;
...
-(void) showSwipe: (_ChannelIO_MGSwipeDirection) direction animated: (BOOL) animated completion:(nullable void(^)(BOOL finished)) completion;
-(void) setSwipeOffset:(CGFloat)offset animated: (BOOL) animated completion:(nullable void(^)(BOOL finished)) completion;
-(void) setSwipeOffset:(CGFloat)offset animation: (nullable _ChannelIO_MGSwipeAnimation *) animation completion:(nullable void(^)(BOOL finished)) completion;
