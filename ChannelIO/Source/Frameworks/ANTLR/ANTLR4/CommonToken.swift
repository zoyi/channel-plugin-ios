...
class CommonToken: WritableToken {
    ...
    init(_ source: TokenSourceAndStream, _ type: Int, _ channel: Int, _ start: Int, _ stop: Int) {
        self.source = source
        self.type = type
    ...
    func setStartIndex(_ start: Int) {
        self.start = start
    }
    ...
    func toString(_ r: Recognizer<ATNSimulator>?) -> String {
