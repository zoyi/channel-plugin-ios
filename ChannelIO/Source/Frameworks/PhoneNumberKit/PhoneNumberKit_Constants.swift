...
enum PhoneNumberKit_PhoneNumberCountryCodeSource {
 ...
 */
enum PhoneNumberKit_PhoneNumberError: Error {
    case generalError
...
extension PhoneNumberKit_PhoneNumberError: LocalizedError {
...
enum PhoneNumberKit_PhoneNumberFormat {
 ...
 */
enum PhoneNumberKit_PhoneNumberType: String, Codable {
    case fixedLine
    case mobile
    case fixedOrMobile
    case pager
...
enum PhoneNumberKit_PossibleLengthType: String, Codable {
  case national
  case localOnly
}
...
struct PhoneNumberKit_PhoneNumberConstants {
...
struct PhoneNumberKit_PhoneNumberPatterns {
    // MARK: Patterns
