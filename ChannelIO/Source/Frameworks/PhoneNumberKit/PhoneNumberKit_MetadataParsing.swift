...
extension PhoneNumberKit_MetadataTerritory {
    ...
    init(from decoder: Decoder) throws {
        ...
        let temporaryFormatList: [PhoneNumberKit_MetadataPhoneNumberFormat] = availableFormats?.decodeArrayOrObject(forKey: .numberFormats) ?? [PhoneNumberKit_MetadataPhoneNumberFormat]()
        ...
        emergency = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .emergency)
        fixedLine = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .fixedLine)
        generalDesc = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .generalDesc)
        mobile = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .mobile)
        pager = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .pager)
        personalNumber = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .personalNumber)
        premiumRate = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .premiumRate)
        sharedCost = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .sharedCost)
        tollFree = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .tollFree)
        voicemail = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .voicemail)
        voip = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .voip)
        uan = try? container.decode(PhoneNumberKit_MetadataPhoneNumberDesc.self, forKey: .uan)
...
extension PhoneNumberKit_MetadataPhoneNumberFormat {
    enum CodingKeys: String, CodingKey {
        case pattern
        case format
        case intlFormat
...
extension PhoneNumberKit_PhoneNumberMetadata {
    enum CodingKeys: String, CodingKey {
    ...
    init(from decoder: Decoder) throws {
        ...
        territories = try territoryObject.decode([PhoneNumberKit_MetadataTerritory].self, forKey: .territory)
    }
}
...
private extension Collection where Element == PhoneNumberKit_MetadataPhoneNumberFormat {
    func withDefaultNationalPrefixFormattingRule(_ nationalPrefixFormattingRule: String?) -> [Element] {
        return self.map { format -> PhoneNumberKit_MetadataPhoneNumberFormat in
