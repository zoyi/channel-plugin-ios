...
@available(iOS 11.0, *)
protocol PhoneNumberKit_CountryCodePickerDelegate: class {
    func countryCodePickerViewControllerDidPickCountry(_ country: PhoneNumberKit_CountryCodePickerViewController.Country)
}

@available(iOS 11.0, *)
class PhoneNumberKit_CountryCodePickerViewController: UITableViewController {
    ...
    weak var delegate: PhoneNumberKit_CountryCodePickerDelegate?
...
@available(iOS 11.0, *)
extension PhoneNumberKit_CountryCodePickerViewController: UISearchResultsUpdating {
...
@available(iOS 11.0, *)
internal extension PhoneNumberKit_CountryCodePickerViewController {
