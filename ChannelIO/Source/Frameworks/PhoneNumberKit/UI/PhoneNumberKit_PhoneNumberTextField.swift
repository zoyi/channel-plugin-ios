...
class PhoneNumberKit_PhoneNumberTextField: UITextField, UITextFieldDelegate {
    ...
    func setTextUnformatted(newValue: String?) {
        super.text = newValue
    }
    ...
    var withExamplePlaceholder: Bool = false {
        didSet {
            if self.withExamplePlaceholder {
                self.updatePlaceholder()
            } else {
    ...
    var countryCodePlaceholderColor: UIColor = {
    ...
    /// Available on iOS 13 and above just.
    var numberPlaceholderColor: UIColor = {
        if #available(iOS 13.0, *) {
    ...
    private(set) lazy var partialFormatter: PhoneNumberKit_PartialFormatter = PhoneNumberKit_PartialFormatter(
    ...
    let nonNumericSet: NSCharacterSet = {
        ...
        mutableSet.remove(charactersIn: PhoneNumberKit_PhoneNumberConstants.plusChars)
        mutableSet.remove(charactersIn: PhoneNumberKit_PhoneNumberConstants.pausesAndWaitsChars)
        mutableSet.remove(charactersIn: PhoneNumberKit_PhoneNumberConstants.operatorChars)
    ...
    /**
     ...
     - returns: PhoneNumber?
     */
    var phoneNumber: PhoneNumberKit_PhoneNumber? {
    ...
    /**
     ...
     - returns: UITextfield
     */
    convenience init(withPhoneNumberKit phoneNumberKit: PhoneNumberKit) {
    ...
    /**
     ...
     - returns: UITextfield
     */
    init(frame: CGRect, phoneNumberKit: PhoneNumberKit) {
    ...
    func updatePlaceholder() {
        ...
        let format = self.withPrefix ? PhoneNumberKit_PhoneNumberFormat.international : .national
    ...
    @objc func didPressFlagButton() {
        ...
        let vc = PhoneNumberKit_CountryCodePickerViewController(phoneNumberKit: phoneNumberKit)
        vc.delegate = self
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        let filteredCharacters = modifiedTextField.filter {
            String($0).rangeOfCharacter(from: (textField as! PhoneNumberKit_PhoneNumberTextField).nonNumericSet as CharacterSet) == nil
        }
...
@available(iOS 11.0, *)
extension PhoneNumberKit_PhoneNumberTextField: PhoneNumberKit_CountryCodePickerDelegate {

    func countryCodePickerViewControllerDidPickCountry(_ country: PhoneNumberKit_CountryCodePickerViewController.Country) {
