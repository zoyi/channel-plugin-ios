...
class PhoneNumberKit_PhoneNumberFormatter: Foundation.Formatter {
    let phoneNumberKit: PhoneNumberKit

    private let partialFormatter: PhoneNumberKit_PartialFormatter
    ...
    init(phoneNumberKit pnk: PhoneNumberKit = PhoneNumberKit(), defaultRegion: String = PhoneNumberKit.defaultRegionCode(), withPrefix: Bool = true) {
        self.phoneNumberKit = pnk
        self.partialFormatter = PhoneNumberKit_PartialFormatter(phoneNumberKit: self.phoneNumberKit, defaultRegion: defaultRegion, withPrefix: withPrefix)
        super.init()
    }

    required init?(coder aDecoder: NSCoder) {
        self.phoneNumberKit = PhoneNumberKit()
        self.partialFormatter = PhoneNumberKit_PartialFormatter(phoneNumberKit: self.phoneNumberKit, defaultRegion: self.defaultRegion, withPrefix: self.withPrefix)
...
extension PhoneNumberKit_PhoneNumberFormatter {
    override func string(for obj: Any?) -> String? {
        if let pn = obj as? PhoneNumberKit_PhoneNumber {
