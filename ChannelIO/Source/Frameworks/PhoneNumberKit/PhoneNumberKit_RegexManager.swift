...
final class PhoneNumberKit_RegexManager {
    ...
    func regexWithPattern(_ pattern: String) throws -> NSRegularExpression {
        ...
        do {
            ...
            throw PhoneNumberKit_PhoneNumberError.generalError
        }
    }
    ...
    func phoneDataDetectorMatch(_ string: String) throws -> NSTextCheckingResult {
        let fallBackMatches = try regexMatches(PhoneNumberKit_PhoneNumberPatterns.validPhoneNumberPattern, string: string)
