...
func _RXSwift_rxAbstractMethod(file: StaticString = #file, line: UInt = #line) -> Swift.Never {
    _RXSwift_rxFatalError("Abstract method", file: file, line: line)
}

func _RXSwift_rxFatalError(_ lastMessage: @autoclosure () -> String, file: StaticString = #file, line: UInt = #line) -> Swift.Never  {
    fatalError(lastMessage(), file: file, line: line)
}

func _RXSwift_rxFatalErrorInDebug(_ lastMessage: @autoclosure () -> String, file: StaticString = #file, line: UInt = #line) {
    #if DEBUG
        fatalError(lastMessage(), file: file, line: line)
    #else
...
func _RXSwift_incrementChecked(_ i: inout Int) throws -> Int {
    if i == Int.max {
        throw _RXSwift_RxError.overflow
    }
    defer { i += 1 }
    return i
}

func _RXSwift_decrementChecked(_ i: inout Int) throws -> Int {
    if i == Int.min {
        throw _RXSwift_RxError.overflow
    }
    defer { i -= 1 }
    ...
    final class _RXSwift_SynchronizationTracker {
