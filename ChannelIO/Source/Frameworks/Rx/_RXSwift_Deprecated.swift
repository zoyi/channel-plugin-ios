...
extension _RXSwift_Observable {
    ...
    @available(*, deprecated, message: "Implicit conversions from any type to optional type are allowed and that is causing issues with `from` operator overloading.", renamed: "from(optional:)")
     static func from(_ optional: Element?) -> _RXSwift_Observable<Element> {
        return _RXSwift_Observable.from(optional: optional)
    }
    ...
    @available(*, deprecated, message: "Implicit conversions from any type to optional type are allowed and that is causing issues with `from` operator overloading.", renamed: "from(optional:scheduler:)")
     static func from(_ optional: Element?, scheduler: _RXSwift_ImmediateSchedulerType) -> _RXSwift_Observable<Element> {
        return _RXSwift_Observable.from(optional: optional, scheduler: scheduler)
    }
}
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Please use enumerated().flatMap()")
     func flatMapWithIndex<Source: _RXSwift_ObservableConvertibleType>(_ selector: @escaping (Element, Int) throws -> Source)
    ...
    @available(*, deprecated, message: "Please use enumerated().skipWhile().map()")
     func skipWhileWithIndex(_ predicate: @escaping (Element, Int) throws -> Bool) -> _RXSwift_Observable<Element> {
    ...
    @available(*, deprecated, message: "Please use enumerated().takeWhile().map()")
     func takeWhileWithIndex(_ predicate: @escaping (Element, Int) throws -> Bool) -> _RXSwift_Observable<Element> {
...
extension _RXSwift_Disposable {
    ...
    @available(*, deprecated, message: "use disposed(by:) instead", renamed: "disposed(by:)")
     func addDisposableTo(_ bag: _RXSwift_DisposeBag) {
...
@available(*, deprecated, message: "Variable is deprecated. Please use `BehaviorRelay` as a replacement.")
 final class _RXCocoa_Variable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "delay(_:scheduler:)")
     func delay(_ dueTime: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timeout(_:scheduler:)")
     func timeout(_ dueTime: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timeout(_:other:scheduler:)")
     func timeout<OtherSource: _RXSwift_ObservableConvertibleType>(_ dueTime: Foundation.TimeInterval, other: OtherSource, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> where Element == OtherSource.Element {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "skip(_:scheduler:)")
     func skip(_ duration: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType where Element : _RXSwift_RxAbstractInteger {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "interval(_:scheduler:)")
     static func interval(_ period: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType where Element: _RXSwift_RxAbstractInteger {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timer(_:period:scheduler:)")
     static func timer(_ dueTime: Foundation.TimeInterval, period: Foundation.TimeInterval? = nil, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "throttle(_:latest:scheduler:)")
     func throttle(_ dueTime: Foundation.TimeInterval, latest: Bool = true, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "take(_:scheduler:)")
     func take(_ duration: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "delaySubscription(_:scheduler:)")
     func delaySubscription(_ dueTime: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "window(_:)")
     func window(timeSpan: Foundation.TimeInterval, count: Int, scheduler: _RXSwift_SchedulerType)
...
extension _RXSwift_ObservableType {
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "buffer(timeSpan:count:scheduler:)")
     func buffer(timeSpan: Foundation.TimeInterval, count: Int, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<[Element]> {
...
extension _RXSwift_PrimitiveSequenceType where Element: _RXSwift_RxAbstractInteger
{
    ...
    @available(*, deprecated, message: "Use DispatchTimeInterval overload instead.", renamed: "timer(_:scheduler:)")
     static func timer(_ dueTime: Foundation.TimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_PrimitiveSequence<Trait, Element>  {
        return timer(.milliseconds(Int(dueTime * 1000.0)), scheduler: scheduler)
    }
}

extension _RXSwift_Completable {
    /**
    ...
    @available(*, deprecated, message: "Use Completable.zip instead.", renamed: "zip")
     static func merge<Collection: Swift.Collection>(_ sources: Collection) -> _RXSwift_Completable
     ...
     */
    @available(*, deprecated, message: "Use Completable.zip instead.", renamed: "zip")
     static func merge(_ sources: [_RXSwift_Completable]) -> _RXSwift_Completable {
        return zip(sources)
    }
