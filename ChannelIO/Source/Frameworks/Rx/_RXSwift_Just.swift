...
extension _RXSwift_ObservableType {
     ...
     */
     static func just(_ element: Element) -> _RXSwift_Observable<Element> {
    ...
    /**
     ...
     - returns: An observable sequence containing the single specified element.
     */
     static func just(_ element: Element, scheduler: _RXSwift_ImmediateSchedulerType) -> _RXSwift_Observable<Element> {
        return JustScheduled(element: element, scheduler: scheduler)
    }
}

final private class JustScheduledSink<Observer: _RXSwift_ObserverType>: _RXSwift_Sink<Observer> {
...
final private class JustScheduled<Element>: _RXSwift_Producer<Element> {
...
final private class Just<Element>: _RXSwift_Producer<Element> {
