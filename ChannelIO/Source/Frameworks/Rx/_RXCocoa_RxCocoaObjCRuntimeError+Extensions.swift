...
//
    ...
    enum _RXCocoa_RxCocoaInterceptionMechanism {
    ...
    enum _RXCocoa_RxCocoaObjCRuntimeError
        : Swift.Error
        ...
        * then unobserving with KVO will restore class to be `OriginalClass` -> failure point (possibly a bug in KVO)
        ...
        dangerous.
        */
        case objectMessagesAlreadyBeingIntercepted(target: AnyObject, interceptionMechanism: _RXCocoa_RxCocoaInterceptionMechanism)
    ...
    extension _RXCocoa_RxCocoaObjCRuntimeError {
    ...
    extension Error {
        func _RXCocoa_rxCocoaErrorForTarget(_ target: AnyObject) -> _RXCocoa_RxCocoaObjCRuntimeError {
            ...
            return _RXCocoa_RxCocoaObjCRuntimeError.unknown(target: target)
        }
    }
