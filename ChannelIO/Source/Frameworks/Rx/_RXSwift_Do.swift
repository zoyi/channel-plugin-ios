...
final private class DoSink<Observer: _RXSwift_ObserverType>: _RXSwift_Sink<Observer>, _RXSwift_ObserverType {
    typealias Element = Observer.Element 
    typealias EventHandler = (_RXSwift_Event<Element>) throws -> Void
    typealias AfterEventHandler = (_RXSwift_Event<Element>) throws -> Void
    
    private let _eventHandler: EventHandler
    private let _afterEventHandler: AfterEventHandler
    
    init(eventHandler: @escaping EventHandler, afterEventHandler: @escaping AfterEventHandler, observer: Observer, cancel: _RXSwift_Cancelable) {
...
final private class Do<Element>: _RXSwift_Producer<Element> {
    typealias EventHandler = (_RXSwift_Event<Element>) throws -> Void
    typealias AfterEventHandler = (_RXSwift_Event<Element>) throws -> Void
    ...
    init(source: _RXSwift_Observable<Element>, eventHandler: @escaping EventHandler, afterEventHandler: @escaping AfterEventHandler, onSubscribe: (() -> Void)?, onSubscribed: (() -> Void)?, onDispose: (() -> Void)?) {
        self._source = source
        self._eventHandler = eventHandler
        self._afterEventHandler = afterEventHandler
    ...
    override func run<Observer: _RXSwift_ObserverType>(_ observer: Observer, cancel: _RXSwift_Cancelable) -> (sink: _RXSwift_Disposable, subscription: _RXSwift_Disposable) where Observer.Element == Element {
        ...
        let allSubscriptions = _RXSwift_Disposables.create {
