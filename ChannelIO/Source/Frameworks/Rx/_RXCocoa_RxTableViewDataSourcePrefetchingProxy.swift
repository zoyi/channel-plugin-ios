...
extension UITableView: _RXCocoa_HasPrefetchDataSource {
...
@available(iOS 10.0, tvOS 10.0, *)
class _RXCocoa_RxTableViewDataSourcePrefetchingProxy
    : _RXCocoa_DelegateProxy<UITableView, UITableViewDataSourcePrefetching>
    ...
    init(tableView: ParentObject) {
        ...
        super.init(parentObject: tableView, delegateProxy: _RXCocoa_RxTableViewDataSourcePrefetchingProxy.self)
    }

    // Register known implementations
    static func registerKnownImplementations() {
        self.register { _RXCocoa_RxTableViewDataSourcePrefetchingProxy(tableView: $0) }
    }

    private var _prefetchRowsPublishSubject: _RXSwift_PublishSubject<[IndexPath]>?

    /// Optimized version used for observing prefetch rows callbacks.
    internal var prefetchRowsPublishSubject: _RXSwift_PublishSubject<[IndexPath]> {
    ...
    override func setForwardToDelegate(_ forwardToDelegate: UITableViewDataSourcePrefetching?, retainDelegate: Bool) {
