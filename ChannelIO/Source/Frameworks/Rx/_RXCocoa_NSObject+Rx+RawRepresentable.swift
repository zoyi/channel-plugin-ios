...
extension _RXSwift_Reactive where Base: NSObject {
     ...
     */
    func observe<Element: RawRepresentable>(_ type: Element.Type, _ keyPath: String, options: _RXCocoa_KeyValueObservingOptions = [.new, .initial], retainSelf: Bool = true) -> _RXSwift_Observable<Element?> where Element.RawValue: _RXCocoa_KVORepresentable {
    ...
    extension _RXSwift_Reactive where Base: NSObject {
         ...
         */
        func observeWeakly<Element: RawRepresentable>(_ type: Element.Type, _ keyPath: String, options: _RXCocoa_KeyValueObservingOptions = [.new, .initial]) -> _RXSwift_Observable<Element?> where Element.RawValue: _RXCocoa_KVORepresentable {
