...
private final class AsSingleSink<Observer: _RXSwift_ObserverType> : _RXSwift_Sink<Observer>, _RXSwift_ObserverType {
...
final class _RXSwift_AsSingle<Element>: _RXSwift_Producer<Element> {
