 ...
 */
struct _RXCocoa_Binder<Value>: _RXSwift_ObserverType {
    typealias Element = Value
    
    private let _binding: (_RXSwift_Event<Value>) -> Void
    ...
    init<Target: AnyObject>(_ target: Target, scheduler: _RXSwift_ImmediateSchedulerType = _RXSwift_MainScheduler(), binding: @escaping (Target, Value) -> Void) {
