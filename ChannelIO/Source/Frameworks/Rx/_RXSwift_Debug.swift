...
final private class DebugSink<Source: _RXSwift_ObservableType, Observer: _RXSwift_ObserverType>: _RXSwift_Sink<Observer>, _RXSwift_ObserverType where Observer.Element == Source.Element {
...
final private class Debug<Source: _RXSwift_ObservableType>: _RXSwift_Producer<Source.Element> {
