...
protocol _RXCocoa_RxCollectionViewDataSourceType /*: UICollectionViewDataSource*/ {
    ...
    func collectionView(_ collectionView: UICollectionView, observedEvent: _RXSwift_Event<Element>)
}
