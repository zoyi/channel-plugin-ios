...
extension _RXSwift_ObservableType {
     ...
     */
    func take(_ duration: _RXSwift_RxTimeInterval, scheduler: _RXSwift_SchedulerType)
        -> _RXSwift_Observable<Element> {
...
final private class TakeCountSink<Observer: _RXSwift_ObserverType>: _RXSwift_Sink<Observer>, _RXSwift_ObserverType {
...
final private class TakeCount<Element>: _RXSwift_Producer<Element> {
...
final private class TakeTimeSink<Element, Observer: _RXSwift_ObserverType>
...
final private class TakeTime<Element>: _RXSwift_Producer<Element> {
    typealias TimeInterval = _RXSwift_RxTimeInterval
    ...
    init(source: _RXSwift_Observable<Element>, duration: TimeInterval, scheduler: _RXSwift_SchedulerType) {
        self._source = source
